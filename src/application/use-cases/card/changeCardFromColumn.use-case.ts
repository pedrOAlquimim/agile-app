...
import { IChangeCardColumnUseCase } from 'src/core/interfaces/useCases/card/IChangeCardColumnUseCase.interface'
import { CustomResponse } from 'src/core/response/customResponse'

export class ChangeCardFromColumnUseCase implements IChangeCardColumnUseCase {
  constructor(
